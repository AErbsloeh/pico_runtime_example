...
if __name__ == "__main__":
    ...
    dut.register(func=dut._thread_record_stream, args=(1, 'util', path2save))
    dut.register(func=dut._thread_stream_mock, args=(2, 'mock', channel_num, sample_rate))
    #dut.register(func=dut._thread_stream_file, args=(2, 'mock', path2data, 0, 'mock'))
    dut.register(func=dut._thread_record_stream, args=(3, 'mock', path2save))
    dut.register(func=dut._thread_plot_stream, args=(4, 'mock', 0.5))
