...
def generate_iir_filter_c(data_bitsize: int, data_signed: bool,
    ...
    filter_emulator = FilterStageGenerator(filter_order, sampling_rate, filter_corner, True,
...
if __name__ == '__main__':
    ...
    generate_iir_filter_c(16, True, 2, 1e3, [100], filter_btype='low', path2save=path2save, filter_id='0')
    generate_iir_filter_c(16, True, 2, 1e3, [100], filter_btype='high', path2save=path2save, filter_id='1')
    generate_iir_filter_c(16, True, 1, 1e3, [100], filter_btype='all', path2save=path2save, filter_id='2')
    generate_iir_filter_c(16, True, 1, 1e3, [10, 100], filter_btype='bandpass', path2save=path2save, filter_id='3')
    generate_iir_filter_c(16, True, 2, 1e3, [10, 100], filter_btype='bandpass', path2save=path2save, filter_id='4')
    generate_iir_filter_c(16, True, 2, 1e3, [10, 100], filter_btype='bandstop', path2save=path2save, filter_id='5')
